...
var _rxjs = __webpack_require__(160);
...
var source = _rxjs.Observable.interval(100 /* ms */).timeInterval().subscribe(function (x) {
    if (!started) return;
    time++;
    draw(time);
...
_rxjs.Observable.fromEvent(document.getElementById('start'), 'click').subscribe(function (e) {
    started = true;
});

_rxjs.Observable.fromEvent(document.getElementById('stop'), 'click').subscribe(function (e) {
    started = false;
});

_rxjs.Observable.fromEvent(document.getElementById('split'), 'click').subscribe(function (e) {
    splitsList.innerHTML += digital.innerHTML + "<br/>";
});

_rxjs.Observable.fromEvent(document.getElementById('reset'), 'click').subscribe(function (e) {
    started = false;
    time = 0;
    draw(time);
